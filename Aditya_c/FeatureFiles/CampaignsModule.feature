...
Scenario Outline: Verify login page is displayed.
...
#Then Campaign details page with title "Zoho CRM - Campaign Details"should be displayed with the following data:
 #     | Campaign Name   | LG Dual Invertor AC|
 #     | Type            | Conference      |
 #     | Start Date      | 03/29/2025	    |
 #     | End Date        | 04/29/2025      |
 #     | Status          | Complete        |
 #     | Expected Revenue| 90980           |
 #     | Budgeted Cost   | 30000           |
 #     | Actual Cost     | 85990           |
 #     | Num Sent        |       2         |

Examples:
|campname|sdate|edate|
|LG Dual Invertor AC|03/29/2025|04/29/2025|