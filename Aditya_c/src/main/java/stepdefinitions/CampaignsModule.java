...
public class CampaignsModule 
{
	...
	public void he_enters_the_expected_revenue_as(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("he enters the Budgeted Cost as {string}")
	public void he_enters_the_budgeted_cost_as(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("he enters the Actual Cost as {string}")
	public void he_enters_the_actual_cost_as(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("he enters the Expected Response as {string}")
	public void he_enters_the_expected_response_as(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}

	@When("he enters the Num Sent as {string}")
	public void he_enters_the_num_sent_as(String string) {
	    // Write code here that turns the phrase above into concrete actions
	    throw new io.cucumber.java.PendingException();
	}
